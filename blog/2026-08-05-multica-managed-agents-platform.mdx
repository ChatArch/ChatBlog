...
![Multica 官方首页上的 Issues 看板示意图](/img/multica-managed-agents-platform/multica-home-board.jpg)
...
![Multica 官方 use case 中，db-boy 在 Issue 评论里自动贴出 weekly metrics 报告](/img/multica-managed-agents-platform/multica-db-boy-weekly-metrics.jpg)
...
![Multica 官方 use case 中 db-boy 的 Agent 个人页与 instructions 页面](/img/multica-managed-agents-platform/multica-db-boy-profile.jpg)
...
![Multica 官方 use case 中，人类在评论里 @db-boy，agent 回复并链接 follow-up Issue](/img/multica-managed-agents-platform/multica-db-boy-ad-hoc-question.jpg)
...
- 图片来源：Multica 官方首页与官方 use case [如何在 Multica 拥有一位 24/7 的高级数据分析师](https://multica.ai/usecases/auto-data-analysis)。本文只使用公开页面中的官方演示图，并在正文中明确标注为官方演示数据。
